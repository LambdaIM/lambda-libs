...
type StateDB struct {
	...
	txIndex      int
	logs         map[common.Hash][]*common.Log
	logSize      uint
...
func New(root common.Hash, db Database) (*StateDB, error) {
	...
	return &StateDB{
		...
		logs:              make(map[common.Hash][]*common.Log),
...
func (self *StateDB) Reset(root common.Hash) error {
	...
	self.txIndex = 0
	self.logs = make(map[common.Hash][]*common.Log)
	self.logSize = 0
...
func (self *StateDB) AddLog(log *common.Log) {
...
func (self *StateDB) GetLogs(hash common.Hash) []*common.Log {
	return self.logs[hash]
}

func (self *StateDB) Logs() []*common.Log {
	var logs []*common.Log
...
func (self *StateDB) Copy() *StateDB {
	...
	state := &StateDB{
		...
		refund:            self.refund,
		logs:              make(map[common.Hash][]*common.Log, len(self.logs)),
	...
	for hash, logs := range self.logs {
		state.logs[hash] = make([]*common.Log, len(logs))
